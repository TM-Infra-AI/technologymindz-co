...
?>
    ...
    <div>
        <div class="card" id="home">
            ...
            <div class="dis_flex">
                ...
                <div class="share_box">
                    ...
                    <a href="https://www.instagram.com/?url=https://<?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo $row['card_id']; ?>" target="_blank">
        ...
        <?php 
            if (!empty($row['d_comp_est_date']) && !empty($row['d_about_us'])) { ?>
