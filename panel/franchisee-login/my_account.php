...
<form  method="POST" enctype="multipart/form-data"  class="my_account_form">
		...
		<div class="input_area"><p>Your Sharing URL</p>
		<input   value="<?php echo "https://$_SERVER[HTTP_HOST]/index.php?token=".$row['id'];  ?>" placeholder="Enter Razorpay Key id" readonly>
		</div>
...
<p>Copyright 2020 || Isavgo Technologies Pvt Ltd</p>
