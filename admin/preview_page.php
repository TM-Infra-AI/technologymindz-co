...
<!----------email to  info----------------------->	
	<div class="card2" id="enquery">
		...
		<form action="#" method="post">
			...
			<input type="" name="c_name" placeholder="Enter Your Name" required style="margin-top:15px;">
...
?>	<br>
		...
		<!--<a href="index.php"><div class="create_card_btn"> Create Your Card @ www.v-card.in</div></a>-->
