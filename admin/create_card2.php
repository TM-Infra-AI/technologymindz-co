...
<!-------------------form ----------------------->	
		...
		<div class="input_box"><p>User Photo (Required)* 100x100 to 400x400 PX</p>
		...
		<div class="input_box"><p>Position/Designation * </p><input type="text" name="d_position" maxlength="100" placeholder="Enter Position/Designation (Ex. Manager etc.)" value="<?php if(!empty($row['d_position'])){echo $row['d_position'];}?>" required></div>
		...
		<div class="input_box"><p>WhatsApp No * </p><input type="text" name="d_whatsapp" maxlength="13" placeholder="Enter WhatsApp Number"  value="<?php if(!empty($row['d_whatsapp'])){echo $row['d_whatsapp'];}?>" ></div>
