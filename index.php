...
<title> Technology Mindz </title>

<head>


<link rel="favicon" href="images/tm-favicon-32x32.png" type="image/*">
<link rel="fav-icon" href="images/tm-favicon-32x32.png" type="image/*">
<link rel="icon" href="images/tm-favicon-32x32.png" type="image/*">
...
<div class="wtsp_chat">
	<a href="https://api.whatsapp.com/send?phone=+18889824016&text=I%20am%20Interested%20For%20Digital%20Visiting%20Card.%20Please%20Share%20Me%20Demo&source=&data=&app_absent=" target="_blank"><img src="images/wtsp.png" alt="Live Chat"></a>
</div>
...
<div class="services" id="services">
	...
	<div class="services_box" onclick="location.href='https://api.whatsapp.com/send?phone=+18889824016&text=I%20am%20Interested%20For%20Digital%20Visiting%20Card.%20Please%20Share%20Me%20Demo&source=&data=&app_absent='" target="_blank"><h3>Digital Visiting Card</h3><p>Still using old boring visiting cards? Now its time to change.</p><div class="pre_btn">Select</div></div>
...
<div class="row_bottom display_flex" id="contact">
	...
	<div class="side1">
		...
		<div class="row_bt_p"><i class="fa fa-phone"></i> <h4>+18889824016</h4></div>
		<div class="row_bt_p"><i class="fa fa-envelope"></i><h4>info@technologymindz.com</h4></div>
		
		
		
		
		<div class="row_bt_p"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3172.586052366929!2d-122.04276712496404!3d37.32863193773559!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fb44b6c2842cf%3A0xadfe6886bba98f44!2s20930%20Fargo%20Dr%2C%20Cupertino%2C%20CA%2095014%2C%20USA!5e0!3m2!1sen!2sin!4v1723487552719!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
...
<footer class="">
    ...
    <p>
		...
		<a href="<?php echo BASE_URL; ?>">Return And Refund</a> &nbsp; || 
		<a href="<?php echo BASE_URL; ?>">Contact Us</a>
	</p><br>

    <p style="color: white;">
		2025 || Website Developed And Managed By 
		<b><a href="<?php echo BASE_URL; ?>" style="color: blue;">Technology Mindz</a></b>
	</p><br>
